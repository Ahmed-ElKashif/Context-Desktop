...
export const OnboardingDashboard = ({
  ...
  useEffect(() => {
    const handleOpenUpload = () => setIsModalOpen(true);
            ...
            <button
              ...
              className={`flex-1 py-5 text-sm flex items-center justify-center gap-2 outline-none border-b-2 transition-colors ${
                activeTab === "upload"
                  ...
                  : "font-semibold text-light-text/80 dark:text-dark-text/50 border-transparent hover:bg-light-border/50 dark:hover:bg-white/5 hover:text-light-primary dark:hover:text-white"
