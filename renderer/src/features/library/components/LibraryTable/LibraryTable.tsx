        ...
        >
          <thead className="group sticky top-0 bg-light-surface/95 dark:bg-[#121214]/95 backdrop-blur-md z-20 border-b border-light-border dark:border-white/5 shadow-sm">
            <tr className="text-[13px] font-medium text-light-text/80 dark:text-white/70">
              ...
              <th className="py-1.5 w-32 sm:w-40">
                {selectedCount > 0 ? "" : "Tags"}
              </th>
              ...
              >
                <div className="flex items-center justify-start gap-1.5">
                  {selectedCount > 0 ? (
                    ...
                    <>File size {renderSortArrow("fileSize")}</>
                  )}
                </div>
              </th>
              ...
              >
                <div className="flex items-center justify-start gap-1.5">
                  {selectedCount > 0 ? (
                    ...
                    <>Modified {renderSortArrow("updatedAt")}</>
                  )}
                </div>
              </th>
          ...
          {hasMore && (
            <tfoot className="w-full">
              <tr ref={loadMoreRef} className="h-10">
                <td
                  colSpan={6}
                  className="text-center text-light-text/40 dark:text-white/30 py-4"
                >
